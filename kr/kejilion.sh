	  ...
	  113|firefox)
		...
		114|xboard)
			...
			docker_app_install() {
				...
				cd Xboard
				#curl -o /home/docker/xboard/compose.yml ${gh_proxy}raw.githubusercontent.com/cedar2025/Xboard/compose/compose.yaml
				sed -i "s/7001:7001/${docker_port}:7001/g" /home/docker/xboard/Xboard/compose.yaml
				#sed -i 's|\./|/home/docker/xboard/|g' /home/docker/xboard/Xboard/compose.yaml
				cd /home/docker/xboard/Xboard/
